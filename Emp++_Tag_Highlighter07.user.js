...
function runScript(){
    ...
    var stylesheet = "<style type='text/css'>" +
        ...
        ".s-conf-tab{height:40px; text-decoration: none; font-size:14px;display:block; text-align:center;" +
        "color:#444;margin: 5px 2px 0px;}" +
        "#s-conf-tabs li.s-selected, #s-conf-tabs li:hover {background-color:#fff;text-decoration:none;font-weight:bold; color: #333}" +
        "#s-conf-tabs a:hover {text-decoration:none;font-weight:bold; color: #333}" +
    ...
    function initConfig(base){
        ...
        $j(".s-conf-tab").parent().on("click", function(){
            ...
            if(!tab.hasClass("s-selected")){
                tab.siblings().removeClass('s-selected');
